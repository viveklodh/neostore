class OrderDetailModel {
  ...
  OrderDetailModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    data = json['data'] != null ? new OrderIDDetails.fromJson(json['data']) : null;
  }
...
class OrderIDDetails {
  ...
  OrderIDDetails({this.id, this.cost, this.address, this.orderDetails});

  OrderIDDetails.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    cost = json['cost'];
